 ...
 * generated in the webservices.client.generated package.
...
public class ObjectFactory {
    ...
    private final static QName _CreateCityResponse_QNAME = new QName("http://lab3.webservices.mileshin.ifmo/", "createCityResponse");
    private final static QName _UpdateCity_QNAME = new QName("http://lab3.webservices.mileshin.ifmo/", "updateCity");
    private final static QName _CreateCity_QNAME = new QName("http://lab3.webservices.mileshin.ifmo/", "createCity");
    private final static QName _DeleteCity_QNAME = new QName("http://lab3.webservices.mileshin.ifmo/", "deleteCity");
    private final static QName _UpdateCityResponse_QNAME = new QName("http://lab3.webservices.mileshin.ifmo/", "updateCityResponse");
    private final static QName _DeleteCityResponse_QNAME = new QName("http://lab3.webservices.mileshin.ifmo/", "deleteCityResponse");
    private final static QName _GetCitiesResponse_QNAME = new QName("http://lab3.webservices.mileshin.ifmo/", "getCitiesResponse");
    private final static QName _GetCities_QNAME = new QName("http://lab3.webservices.mileshin.ifmo/", "getCities");
     ...
     *
     */
    @XmlElementDecl(namespace = "http://lab3.webservices.mileshin.ifmo/", name = "createCityResponse")
     ...
     *
     */
    @XmlElementDecl(namespace = "http://lab3.webservices.mileshin.ifmo/", name = "updateCity")
     ...
     *
     */
    @XmlElementDecl(namespace = "http://lab3.webservices.mileshin.ifmo/", name = "createCity")
     ...
     *
     */
    @XmlElementDecl(namespace = "http://lab3.webservices.artslob.ifmo/", name = "deleteCity")
     ...
     *
     */
    @XmlElementDecl(namespace = "http://lab3.webservices.mileshin.ifmo/", name = "updateCityResponse")
     ...
     *
     */
    @XmlElementDecl(namespace = "http://lab3.webservices.mileshin.ifmo/", name = "deleteCityResponse")
     ...
     *
     */
    @XmlElementDecl(namespace = "http://lab3.webservices.mileshin.ifmo/", name = "getCitiesResponse")
     ...
     *
     */
    @XmlElementDecl(namespace = "http://lab3.webservices.mileshin.ifmo/", name = "getCities")
