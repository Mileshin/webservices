...
public class ObjectFactory {
    ...
    private final static QName _GetPersonsByFilter_QNAME = new QName("http://standalone.webservices/", "getPersonsByFilter");
    private final static QName _GetPersonsByFilterResponse_QNAME = new QName("http://standalone.webservices/", "getPersonsByFilterResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://standalone.webservices/", name = "getPersonsByFilter")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://standalone.webservices/", name = "getPersonsByFilterResponse")
