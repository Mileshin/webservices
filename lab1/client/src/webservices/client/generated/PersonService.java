 ...
 * 
 */
@WebServiceClient(name = "PersonService", targetNamespace = "http://standalone.webservices/", wsdlLocation = "http://localhost:2987/PersonService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICE_QNAME = new QName("http://standalone.webservices/", "PersonService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:2987/PersonService?wsdl");
    ...
    public PersonWebService getPersonWebServicePort() {
        return super.getPort(new QName("http://standalone.webservices/", "PersonWebServicePort"), PersonWebService.class);
    }
    ...
    public PersonWebService getPersonWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://standalone.webservices/", "PersonWebServicePort"), PersonWebService.class, features);
    }
