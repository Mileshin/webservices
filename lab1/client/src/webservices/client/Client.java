...
import webservices.client.generated.Person;
import webservices.client.generated.PersonService;
...
public class Client {
    public static void main(String[] args) throws MalformedURLException {
        URL url = new URL("http://localhost:2987/PersonService/?wsdl");
            ...
            while (flag) {
                ...
                switch (type) {
                    case "1":
                        ...
                        break;
                    case "2":
                        url = new URL("http://localhost:2987/javaee/PersonService?wsdl");
                        flag = false;
                        break;
                    default:
